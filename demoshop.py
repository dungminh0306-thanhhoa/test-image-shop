...
products = [
    ...
    {"id": 2, "name": "Quần jean", "price": 250000,
     "image": "https://import streamlit as st
from PIL import Image
import requests
from io import BytesIO
import datetime
...
products = [
    {"id": 1, "name": "Áo thun",   "price": 120000,
     "image": "https://drive.google.com/file/d/1s6sJALOs2IxX5f9nqa4Tf8zut_U9KE3O/view?usp=drive_link"},
    {"id": 2, "name": "Quần jean", "price": 250000,
     "image": "https://https://drive.google.com/file/d/1UpNF_Fd5gWbrtEliUbD7KDRilpcnQK3H/view?usp=sharing"},
    {"id": 3, "name": "Áo khoác",  "price": 350000,
     "image": "https://drive.google.com/file/d/1p7k6veSdeL9ozWzIjWpFiAJSIgOR2HE6/view?usp=sharing"},
